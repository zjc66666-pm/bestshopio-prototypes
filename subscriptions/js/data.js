...
window.DATA_SUBS = {
  ...
  contracts: [
    ...
    { id: 'SUB-20452', customer: 'Liam Smith',     email: 'liam.s@example.com',   plan: 'Daily Vitamins — Monthly',   planId: 'PL-1002', product: 'Daily Multivitamin (60 ct)', status: 'active',   next: '2026-06-19', amount: 32, currency: 'USD', cyclesDone: 3, gateway: 'paypal',    method: 'PayPal',               qty: 1, startedAt: '2026-03-19', address: '9 Oak Ave, Denver, CO 80202, US',
      history: [ { id: '#1056-R3', date: '2026-05-19', amount: 32, status: 'paid', cycle: 3 }, { id: '#1056-R2', date: '2026-04-19', amount: 32, status: 'paid', cycle: 2 } ] },
    ...
    { id: 'SUB-20457', customer: 'Mason Garcia',   email: 'mason.g@example.com',  plan: 'Daily Vitamins — Monthly',   planId: 'PL-1002', product: 'Daily Multivitamin (60 ct)', status: 'active',   next: '2026-06-20', amount: 32, currency: 'USD', cyclesDone: 1, gateway: 'paypal',    method: 'PayPal',               qty: 1, startedAt: '2026-05-20', address: '8 Spruce Way, Phoenix, AZ 85001, US',
      history: [ { id: '#1070-R1', date: '2026-05-20', amount: 32, status: 'paid', cycle: 1 } ] },
    { id: 'SUB-20458', customer: 'Isabella Martin', email: 'isabella.m@example.com', plan: 'Skincare Refill — Bimonthly', planId: 'PL-1003', product: 'Vitamin C Serum Refill 30ml', status: 'cancelled', next: '', amount: 45, currency: 'USD', cyclesDone: 8, gateway: 'airwallex', method: 'Visa ···· 6677', qty: 1, startedAt: '2024-09-10', endedAt: '2026-05-10', address: '61 Walnut Dr, Chicago, IL 60601, US',
      history: [ { id: '#0980-R8', date: '2026-03-10', amount: 45, status: 'paid', cycle: 8 } ] },
  ...
  orders: [
    { id: '#1042-R5', contract: 'SUB-20451', customer: 'Emma Johnson',    plan: 'Coffee Club — Monthly',      date: '2026-05-22', amount: 24, currency: 'USD', status: 'paid',     cycle: 5, gateway: 'airwallex', mainOrder: '#1042' },
    { id: '#1056-R3', contract: 'SUB-20452', customer: 'Liam Smith',      plan: 'Daily Vitamins — Monthly',   date: '2026-05-19', amount: 32, currency: 'USD', status: 'paid',     cycle: 3, gateway: 'paypal',    mainOrder: '#1056' },
    { id: '#1033-R7', contract: 'SUB-20454', customer: 'Noah Davis',      plan: 'Pet Food — Monthly',         date: '2026-06-16', amount: 58, currency: 'USD', status: 'retrying', cycle: 7, gateway: 'airwallex', mainOrder: '#1033', attempt: 2, nextRetry: '2026-06-19' },
    { id: '#1061-R2', contract: 'SUB-20453', customer: 'Olivia Brown',    plan: 'Skincare Refill — Bimonthly', date: '2026-05-02', amount: 45, currency: 'USD', status: 'paid',     cycle: 2, gateway: 'stripe', mainOrder: '#1061' },
    { id: '#1044-R4', contract: 'SUB-20455', customer: 'Ava Wilson',      plan: 'Coffee Club — Monthly',      date: '2026-05-01', amount: 48, currency: 'USD', status: 'paid',     cycle: 4, gateway: 'airwallex', mainOrder: '#1044' },
    ...
    { id: '#1044-R3', contract: 'SUB-20455', customer: 'Ava Wilson',      plan: 'Coffee Club — Monthly',      date: '2026-04-01', amount: 48, currency: 'USD', status: 'paid',     cycle: 3, gateway: 'airwallex', mainOrder: '#1044' },
  ],
