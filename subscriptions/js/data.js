...
window.DATA_SUBS = {
  ...
  plans: [
    { id: 'PL-1001', name: 'Coffee Club',                status: 'active', product: 'Signature Blend Coffee 500g', sku: 'COF-500',
    ...
    { id: 'PL-1002', name: 'Daily Vitamins',             status: 'active', product: 'Daily Multivitamin (60 ct)', sku: 'VIT-60',
    ...
    { id: 'PL-1003', name: 'Skincare Refill',             status: 'active', product: 'Vitamin C Serum Refill 30ml', sku: 'SKN-VC30',
    ...
    { id: 'PL-1004', name: 'Pet Food',                   status: 'active', product: 'Grain-Free Dog Food 5kg', sku: 'PET-5K',
    ...
    { id: 'PL-1005', name: 'Protein Resupply',           status: 'active', product: 'Whey Protein 1kg', sku: 'PRO-1K',
    ...
    { id: 'PL-1008', name: 'Wellness Set',                     status: 'active', itemType: 'bundle',
    ...
    { id: 'PL-1012', name: 'Coffee Office Pack', status: 'active', itemType: 'bundle',
