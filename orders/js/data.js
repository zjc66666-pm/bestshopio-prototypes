...
(function () {
  ...
  const DETAILS = {
    ...
    5046: {
      ...
      note: 'QA sample: bundle subscription, one-time bundle, normal subscription, normal subscription with Product Discount, Product Discount-only normal item, and standard normal item in one order. Preserve item-level bundle, subscription, and product-discount snapshots for future renewals.',
      sub: { id: 'SUB-20471', cycle: 1, next: '2026-08-20', deliveryLabel: 'Delivery every 2 months (-$13.99)' },
      bundle: { id: 'BND-07', name: 'Coffee Office Pack' },
      total_num: 10, subtotal: 187.35, shipping_fee: 8.99, total: 182.35, paid_amount: 182.35,
      ...
      timeline: [
        ...
        { label: 'One-time mug, Home Barista Essentials bundle, multivitamin, and coffee scoop included', time: '2026-06-20 09:19' },
